...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#%E5%A4%87%E6%B3%A8">备注</a></li></ol></nav>'
        } })
};
